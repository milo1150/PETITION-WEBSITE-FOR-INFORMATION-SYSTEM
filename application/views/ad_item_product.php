...
<main>
			...
			<div class="table-responsive" style="overflow-x:hidden;">
				<p class="text-center text-dark" style="margin-top: 15px; font-size: 35px; font-weight: bold;">ยืมของ - รายการวัสดุ</p>
				<!---------------------------------------- ADD / DEL ITEM --------------------------------------------->		
					<div class="row" style="margin-top:-20px; margin-bottom:20px; float:left;">
						...
						<form action="<?php echo base_url()?>ad_item/item_product_editndel"><button class="btn warning-color font-weight-bolder" style="margin-left: 10px; font-size: 16px;"><i class="fas fa-edit"></i> แก้ไขรายการ</button></form>
						<form action="<?php echo base_url()?>ad_item/item_product_log"><button class="btn secondary-color font-weight-bolder" style="margin-left: 10px; font-size: 16px;"><i class="fas fa-tasks"></i> ประวัติรายการ</button></form>
					</div>
				<!---------------------------------------- Main Table --------------------------------------------->						
					...
					?>						
						<tr>
							...
							<td class="text-center font-weight-bolder">	
								<form action="<?php echo base_url();?>ad_item/history_pd" method="GET"><button value="<?php echo $row->item_name;?>" name="item_name"  type="submit" class="btn cyan lighten-3"><i class="fas fa-search" ></i></button></form>																								
							</td>
						</tr>					
					<?php } ?>
					</tbody>				
			...
			<div class="modal fade " id="add_item" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" 
				style="font-family: 'Kanit', sans-serif;" data-backdrop="static">
					<div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 1000px;">
						<div class="modal-content z-depth-2" style="padding-inline-start: 25px;">
							<div class="modal-body text-center">
								...
								<div class="modal-body text-center">
									...
									<div class="row justify-content-center mb-3">
										...
										<div class="col-4 form-inline">
										<div class="row" style="padding-inline-end: 20px;">
												<label>หน่วย&nbsp;&nbsp;</label>
												<input type="text" class="form-control" id="item_units" style="max-width: 209px; box-shadow: 5px 5px 1px #aaaaaa;"></input>
													<span id="error_units" style="max-height: 0px; padding-left: 56px;"></span>
											</div>
										</div>
...
function add_item(){
	...
	var item_units = $('#item_units').val();
	$.ajax({
		url:"<?php echo base_url();?>ad_item/item_product_add",
		method:"POST",
		dataType:"JSON",
		data:{'item_name':item_name , 'item_unit':item_unit , 'item_units':item_units , 'ad_username':ad_username},
