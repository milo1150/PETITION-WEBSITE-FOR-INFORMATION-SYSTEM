...
<div class="table-responsive text-center">
	<div class="container-fluid warning-color z-depth-1-half" style="width:100%; font-family: 'Kanit', sans-serif;">
		<h3>แบบฟอร์มขอเปิดอีเมล์</h3>
	</div>
</div>

<form method="post" action="<?php echo base_url()?>index.php/request_email/error" style="font-family: 'Kanit', sans-serif;">
		...
		<div class="container" style="max-width:400px;">
			...
			<div class="form-row pb-2">
				<div class="col">
					...
					<input type="text" name="firstnameth" class="form-control" value="<?php echo $firstnameth; ?>">
					<?php echo form_error('firstnameth'); ?>
				</div>
				<div class="col">
					<label>นามสกุล (ภาษาไทย)</label>
					<input type="text" name="lastnameth" class="form-control" value="<?php echo $lastnameth; ?>">
					<?php echo form_error('lastnameth'); ?>
				</div>
			</div>
