...
<div class="table-responsive text-center">
	<div class="container-fluid red ligthen-1 z-depth-1-half" style="width:100%; height:250px; font-family: 'Kanit', sans-serif;">
...
<form method="post" action="<?php echo base_url()?>index.php/dash_fix/dashtest" style="font-family: 'Kanit', sans-serif;">
	<div class="table-responsive-md pb-4 pt-4" >
		<div class="container" style="max-width:400px;">
			<form class="" method="" action="">
				...
				<div class="form-group">
					...
					<input type="text" name="phonenum" class="form-control" placeholder="">
				...
				<div class="form-group">
					<label>วันที่และเวลากำหนดซ่อม</label>
					<input type="text" name="worktime" class="form-control" placeholder="">
		...
		<!-- <?php if($this->uri->segment(2)=="success"){echo '<p>ส่งคำขอเรียบร้อย</P>';}?> -->
</form>
