...
<head>
	...
	<script src="https://www.google.com/recaptcha/api.js?render=6Lcxr7oZAAAAAGRAom_IazRhpHtZEEiiJjdnyPbO"></script>
		...
		<div class="rq_item">
         	<h3 class="mrq_h">แบบฟอร์มยืมของ</h3>
      	</div>
	...
	<div class="table-responsive-md pb-4 pt-4 request_body">
		<div class="container z-depth-1 reqform">
			...
			<!------------------------------------------------------ final modal---------------------------------------------------->
			<div class="modal fade " id="form_ready" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="font-family: 'Kanit', sans-serif;" data-backdrop="static">
							...
							<div class="modal-body text-center">
								...
								<div class="modal-body text-center">
									<div class="row justify-content-center mb-3">
										...
										<div class="col-4">	
											<button  id="dis_modal" class="btn btn-md btn-block red accent-4 text-white" style="font-size:16px;">ยกเลิก</button>																															
										</div>	
									</div>
								</div>																											
							</div>
...
<script src="<?php echo base_url().'miscit-js/req_item.js';?>"></script>
<script>
