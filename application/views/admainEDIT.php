	...
	<div id="content">
		<nav class="navbar navbar-expand rounded mb-0 admainedit_nav">
			<div class="container-fluid float-left">
				...
				<!--
				<div class="dropdown-tt dropdown dropleft">
					<span class="dropdown-tt label label-pill count" style="border-radius:30px;"> </span>
						<button class="btn dropdown-tt btn-danger" type="button" id="dropdownMenu1" data-toggle="dropdown"
							aria-haspopup="true" aria-expanded="true">
							<i class="dropdown-tt fas fa-envelope" style="font-size:px;"></i>
						</button>
					<ul class="dropdown-tt dropdown-menu" style="width:195px;"></ul>
				</div>
-->
