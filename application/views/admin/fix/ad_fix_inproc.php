...
<main>
			...
			<div class="table-responsive">
				<p class="text-center text-dark" style="margin-top: 15px; font-size: 35px; font-weight: bold;">รายการแจ้งซ่อม - กำลังดำเนินการ</p>										
				<table class="table table-bordered table-hover text-nowrap mytable shadow" style="margin-top: 10px;">
					...
					<?php 														                        
						foreach($fix_inproc as $row){										 
					?>						
						<tr>
							<td class="text-center font-weight-bolder amber darken-1" style="padding-top:21px; font-size:16px;" name=""><?php echo $row->id;?></td>
							...
							<form action="<?php echo base_url();?>ad_fix/report_fix_inproc" method="POST"><button value="<?php echo $row->id;?>" name="id"  type="submit" class="btn cyan lighten-3"><i class="fas fa-search" ></i></button></form>																								
							</td>
						</tr>					
				<?php } ?>			
				</table>
