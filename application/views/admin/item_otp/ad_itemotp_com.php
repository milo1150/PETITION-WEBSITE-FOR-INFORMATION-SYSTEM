...
<meta charset="utf8">
<head>
<title>คำร้องของเบิกของ - เสร็จสมบูรณ์</title>
</head>
<style>
table {
...
<main>
			...
			<div class="table-responsive">
				<p class="text-center text-dark" style="margin-top: 15px; font-size: 35px; font-weight: bold;">คำร้องของเบิกของ - เสร็จสมบูรณ์</p>								
				<table class="table table-bordered table-hover text-nowrap mytable shadow" style="margin-top: 10px;">
					...
					?>						
						<tr>
							...
							<form action="<?php echo base_url();?>ad_itemotp/report_itemotp_com" method="POST"><button value="<?php echo $row->id;?>" name="id"  type="submit" class="btn cyan lighten-3"><i class="fas fa-search" ></i></button></form>																								
							</td>
							</tr>					
					<?php } ?>
				</tr>				
